...
class Popup2 {
    ...
    addEnterButton(callback) {
      this.buttons["Enter"] = callback
    }
...
function addServerPopup2() {
    let popup = new Popup2('Add a Server');
    ...
    popup.addEnterButton(function() { addServer(popup) })
